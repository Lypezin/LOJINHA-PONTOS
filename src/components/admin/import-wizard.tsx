  ...
  return (
    <section className="rounded-[20px] border border-slate-200 bg-white p-5 shadow-sm sm:p-7" aria-labelledby="wizard-title">
      ...
      <div className="mt-7">
        ...
        <p className="mt-2 text-pretty text-sm leading-6 text-slate-600">O arquivo precisa conter as guias BANCO DE DADOS e DADOS CNPJ. A prévia não altera o banco.</p>
      </div>
      ...
      {preview ? (
        <div className="mt-7 space-y-6 border-t border-slate-200 pt-7">
          ...
          <div className="grid gap-5 lg:grid-cols-2">
            ...
            <section className="rounded-2xl bg-slate-50 p-5" aria-labelledby="sheet-summary"><h4 id="sheet-summary" className="font-extrabold text-[var(--brand-navy)]">Guias reconhecidas</h4><dl className="mt-4 space-y-3 text-sm"><div className="flex justify-between gap-4"><dt className="text-slate-500">Dados</dt><dd className="font-bold text-right text-[var(--brand-navy)]">{preview.sheets.data} • cabeçalho {preview.sheets.dataHeaderRow}</dd></div><div className="flex justify-between gap-4"><dt className="text-slate-500">CNPJ</dt><dd className="font-bold text-right text-[var(--brand-navy)]">{preview.sheets.cnpj} • cabeçalho {preview.sheets.cnpjHeaderRow}</dd></div></dl></section>
          </div>
