...
const fieldClass = "min-h-11 w-full rounded-xl border border-slate-300 bg-white px-3 text-sm text-[var(--brand-navy)] outline-none file:mr-3 file:rounded-xl file:border-0 file:bg-blue-50 file:px-3 file:py-2 file:text-xs file:font-bold file:text-[var(--brand-blue-dark)] focus:border-[var(--brand-blue)] focus:ring-4 focus:ring-blue-100";
